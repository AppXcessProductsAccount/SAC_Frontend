...
export default function TestimonialsModern({ content }: Props) {
    ...
    return (
        <section className="relative w-full bg-white py-12 md:py-20 px-4 md:px-8 font-sans" id="testimonials">
            <div className="max-w-[1500px] mx-auto">
                ...
                >
                    ...
                    <h2 className="text-[36px] md:text-[48px] lg:text-[56px] font-sans text-[#1b1b2b] leading-[1.1] tracking-tight whitespace-pre-line relative z-10 flex items-baseline gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {displayData.testimonials.map((testimonial, index) => (
                        <motion.div
                            ...
                            className="relative w-full min-h-[350px] rounded-[24px] md:rounded-[40px] bg-[#f5f6f6] shadow-sm p-8 md:p-12 flex flex-col justify-between group hover:shadow-md transition-shadow duration-500 overflow-hidden"
                        >
                            ...
                            <div className="relative z-10 mb-8">
                                <span className="block text-[#1b1b2b]/10 font-serif text-[60px] leading-[0.5] mb-4">"</span>
                                <p className="text-[#1b1b2b]/80 text-[15px] md:text-[17px] leading-[1.8] font-medium pr-2">
                                    {testimonial.quote}
                                </p>
                            </div>
