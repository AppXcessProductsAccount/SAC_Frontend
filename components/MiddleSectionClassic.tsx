        ...
        <section className="relative py-32 bg-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-8 md:px-12">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-[36px] md:text-[48px] font-serif text-[#101848] mb-6 leading-tight">
                            {displayData.title}
                        </h2>
                        <p className="text-[16px] md:text-[18px] text-[#233252]/80 font-sans mb-8 leading-relaxed">
                            {displayData.text}
                        </p>
                    ...
                    <div className="space-y-12">
                        ...
                        <motion.div
                            ...
                            className="bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-[#101848]/5 relative"
                        >
                            <span className="absolute -top-6 left-8 text-[100px] text-[#101848]/5 font-serif leading-none">"</span>
                            <p className="text-[18px] md:text-[20px] text-[#101848] font-serif italic mb-6 relative z-10">
                        ...
                        >
                            <div className="relative h-[250px] w-full">
                                ...
                                <div className="absolute bottom-0 left-0 p-8">
                                    <h3 className="text-2xl md:text-3xl font-serif text-white mb-2">{displayData.group_meditation.title}</h3>
                                    <p className="text-white/80 text-sm md:text-base font-sans max-w-sm">
